      ...
      <div className="min-h-screen bg-black flex items-center justify-center px-6">
        <div className="max-w-md w-full">
          <div className="bg-white/5 border border-white/10 rounded-3xl backdrop-blur-sm p-8 text-center">
            ...
            <h2 className="text-white font-semibold text-2xl mb-2">Check Your Email!</h2>
            <p className="text-white/60">We've sent a confirmation link to verify your account.</p>
          </div>
        </div>
      </div>
    );
